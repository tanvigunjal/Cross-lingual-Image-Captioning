...
from models.LSTM import DecoderWithAttention
from models.transformer import *
from src.dataset import *
from src.utils import *

# login wandb
wandb.login(key="./wandb_api_key.txt")
...
def train(args, train_loader, encoder, decoder, criterion, encoder_optimizer, decoder_optimizer, epoch):
    ...
    #activate wandb integration to automatically log gradients and parameters 
    wandb.watch(decoder, log="all")
    wandb.watch(encoder, log="all")

    wandb.unwatch(decoder)
    wandb.unwatch(encoder)
    ...
    for i, (imgs, caps, caplens) in enumerate(train_loader):
        ...
        wandb.log({"loss": losses.avg, "top5accs": top5accs.avg})
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', default="coco_5_cap_per_img_3_min_word_freq",
    ...
    parser.add_argument('--decoder_dim', type=int, default=512, help='dimension of decoder LSTM')
    ...
    parser.add_argument('--attention_method', default="ByPixel", help='attention method')
    ...
    # wandb init
    wandb.init(project="project_name", entity="name",
               config={"epochs": args.epochs, "batch_size": args.batch_size, "encoder_lr": args.encoder_lr,
                       "decoder_lr": args.decoder_lr,"fine_tune_embedding": args.fine_tune_embedding, 
                       "emb_dim": args.emb_dim, "attention_dim": args.attention_dim, "decoder_dim": args.decoder_dim,
                       "n_heads": args.n_heads, "dropout": args.dropout, "decoder_mode": args.decoder_mode,
    ...
    # print length of word_map
    print("length of word_map: {}".format(len(word_map)))
